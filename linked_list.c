...
/**
 * create_node_stackfirst - create node stack.
...
/**
 * create_node_stackend - create node stack at end.
 * @stack: A pointer to top and bottom stack.
 * @n: the value
 * Return: the node
 */
...
/**
 * add_dnodeint - adds new node on beginning of a dlistint_t list.
 * @head: pointer to the 1st element of the list
 * @n:integer
 * Return: pointer to a new node at the beginning of a dlistint_t list
 */
